...
class PropertyProperty(models.Model):
    ...
    property_for = fields.Selection([('sale', 'For Sale'), ('rent', 'For Rent'), ('lease', 'For Lease')], string='Property For', required=True)
    ...
    area_type_id = fields.Many2one('property.area.type', string='Property Area Type')
    ...
    def create_units(self):
        ...
        self.ensure_one()
        action = self.env.ref('property_management_rental_sales.action_unit_creation_wizard').read()[0]
        ...
        ctx.update({
            ...
            'default_unit_prefix': f"{self.name}-Unit",
