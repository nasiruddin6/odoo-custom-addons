...
class SOInstallmentLine(models.Model):
    ...
    @api.depends('so_id', 'so_id.unit_id', 'so_id.unit_id.taxes_id')
    def _compute_taxes_id(self):
        """Get taxes from parent sale order's unit."""
        for line in self:
            if line.so_id and line.so_id.unit_id and line.so_id.unit_id.taxes_id:
                line.taxes_id = line.so_id.unit_id.taxes_id
            else:
                line.taxes_id = False
    ...
    def _prepare_base_line_for_taxes_computation(self, **kwargs):
        ...
        return self.env['account.tax']._prepare_base_line_for_taxes_computation(
            ...
            **{
                ...
                'quantity': 1.0,
                'partner_id': self.so_id.partner_id if self.so_id else self.env.company.partner_id,
    ...
    def _compute_amount(self):
        ...
        for line in self:
            ...
            self.env['account.tax']._add_tax_details_in_base_line(base_line, line.so_id.company_id if line.so_id else self.env.company)
            line.vat = base_line['tax_details']['raw_total_included_currency'] - base_line['tax_details']['raw_total_excluded_currency']
    ...
    def action_create_invoice(self):
        ...
        for installment in self:
            ...
            invoice_lines = [(0, 0, {
                ...
                'tax_ids': [(6, 0, installment.taxes_id.ids)],
            })]
